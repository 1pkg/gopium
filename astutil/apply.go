...
func ufmt(w gopium.XWalker, fmt fmtio.Ast) Apply {
	return func(
		ctx context.Context,
		pkg *ast.Package,
		loc gopium.Locator,
...
func filter(w gopium.XWalker) Apply {
	return func(
		ctx context.Context,
		pkg *ast.Package,
		loc gopium.Locator,
...
func note(w gopium.XWalker, p gopium.AstParser, pr fmtio.Printer) Apply {
	return func(
		ctx context.Context,
		pkg *ast.Package,
		loc gopium.Locator,
