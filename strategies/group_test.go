...
func TestGroup(t *testing.T) {
	...
	table := map[string]struct {
		...
		"mixed struct with inconsistent tags should be applied to itself with error": {
			...
			err: errors.New(`inconsistent strategies list "comment_fields_annotate" for field "test" in default group`),
		},
			...
			o: gopium.Struct{
				...
				Fields: []gopium.Field{
					...
					},
					{
						...
						Size:  8,
						Align: 4,
						Tag:   `gopium:"cache_rounding_cpu_l1,explicit_padings_system_alignment"`,
					},
					{
						Name:  "test-5",
						Size:  8,
