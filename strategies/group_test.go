				...
				Fields: []gopium.Field{
					{
						...
						Size:  12,
						Align: 8,
						Tag:   `gopium:"group:def-2;fields_annotate_comment,explicit_paddings_system_alignment,cache_rounding_cpu_l1"`,
					},
					{
						Name:  "test-2",
						Size:  8,
					...
					},
					{
						...
						Size:  8,
						Align: 4,
						Tag:   `gopium:"cache_rounding_cpu_l1,explicit_paddings_system_alignment"`,
					},
					{
						Name:  "test-5",
						Size:  8,
